...
> During the data-cleaning process, I found out that the occupancy rate
> of the few buildings in the dataset is very low. I decided to remove 
> these buildings from consideration because some strange things may 
> happen to these buildings and may distort the analysis. After removing 
> these low-occupancy buildings from the data set, I looked at green 
> buildings and non-green buildings separately. The median market rent 
> for non-green buildings was $25 per square foot per year, while the 
> median market rent for green buildings was $27.60 per square foot per 
> year: an increase of approximately $2.60 per square foot.  Since the 
> median size of the building is 250,000 square feet, this will translate
> for an additional $250,000 x 2.6 = $650,000 revenue per year if we build
> green buildings.)

> I hypothetically set the construction to be $50 million, with a 5% 
> expected premium for green certification. Thus I would expect an extra 
> $2.5 million spending on the green building. Based on the extra revenue we
> would make, we would recover these costs in $2500000/650000 = 3.8 years. 
> Even if our occupancy rate were only 90%, we would still recover the costs
> in about 4 years. Thus from year 4 onwards, we would be making an extra 
> $650,000 per year in profit. Since the building will be earning rents for
> 30 years or more, it seems like it will be an attractive financial incentive
> to build the green building.
...
In total, we have selected 6 ETFs - ?€œQQQ?€?, ?€œSPY?€?, ?€œSVXY?€?, ?€œEPV?€?, ?€œAOR?€?
and ?€œYYY?€?. We have considered 5 years of ETF data starting from
01-Jan-2014.
...
ETFs: ?€œQQQ?€?, ?€œSPY?€?, ?€œSVXY?€?, ?€œEPV?€?, ?€œAOR?€?, ?€œYYY?€?
...
remain nameless?€”let?€™s call it ?€œNutrientH20?€? just to have a label. The
...
marketing campaigns. For example, Cluster 4 - ?€œCooking, Personal
Fitness, Food, Shopping, Fashion?€? and Cluster 5 - ?€œTravel, Outdoors,
...
demographics. Intuitively, Cluster 4 - ?€œCollege Universities, Online
Gaming, News?€? will consist of a younger population as compared to
Cluster 5 - ?€œReligion, Food, Parenting, School, Family?€?. NutrientH20 can
...
We transform the data into a ?€œtransactions?€? class before applying the
